export const SITE = {
  website: "https://example.netlify.app/", // replace this with your deployed domain
  ...
  title: "Harrison Chojnowski's Blog",
  ...
  editPost: {
    enabled: false,
    text: "Edit page",
    url: "https://github.com/hachoj/astro-paper/edit/main/",
  },
